...
export const BOARD_PRESETS: { label: string; value: BoardConfig }[] = [
  { label: '8 × 8',   value: { rows: 8,  cols: 8  } },
  { label: '10 × 10', value: { rows: 10, cols: 10 } },
  { label: '12 × 12', value: { rows: 12, cols: 12 } },
]

export const DEFAULT_BOARD_CONFIG: BoardConfig = BOARD_PRESETS[1].value  // 10×10
